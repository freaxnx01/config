...
| Commands | [`setup/01-claude-commands.sh`](setup/01-claude-commands.sh) | Generic slash commands from this repo **plus** the issue-workflow console from [agent-workflow](https://github.com/freaxnx01/agent-pipeline) (cloned + linked automatically) into `~/.claude/commands/` — see [list](claude/commands/README.md) |
...
- [`claude/`](claude/) — partials, generic [commands](claude/commands/README.md), and [hooks](claude/hooks/)
  (the issue-workflow console commands live in [agent-workflow](https://github.com/freaxnx01/agent-pipeline)`/commands/`, installed by the same bootstrap)
